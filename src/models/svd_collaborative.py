"""
Layer 2: Matrix Factorization using SVD (Singular Value Decomposition).
Utilizes the Surprise library to model latent user-item interactions.
Acts as a ranking refinement layer for candidates generated by Layer 1.
"""
# Scripts
...
class CollaborativeFilteringSVD:
    """
    Wrapper for SVD collaborative filtering algorithm.
    Decomposes the rating matrix into user and item latent factors.
    """
    
    def __init__(self, n_factors=50, n_epochs=20, lr=0.005, reg=0.02):
        """
        Configure the SVD algorithm parameters.
        
        Args:
            n_factors (int): Dimensionality of latent factors (e.g., 50).
            n_epochs (int): Number of iterations for SGD training.
            lr (float): Learning rate.
            reg (float): Regularization term to prevent overfitting.
        """
        self.model = SVD(
            n_factors=n_factors,
            n_epochs=n_epochs,
    ...
    def train(self, train_data):
        """
        Execute training of the SVD model on the provided dataset.
        
        Args:
            train_data (pd.DataFrame): Data containing ['user_id', 'item_id', 'rating'].
        """
